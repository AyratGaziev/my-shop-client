...
const ProductOverview: React.FC<RouteComponentProps<PordParamsType>> = ({
    match
}) => {
    ...
    const reviews = useSelector(
        (state: RootState) => state.products.productOverview.reviews
    );
                    ...
                    <div className="product__about">
                        ...
                        <div className="product__features">
                            {features.map(({ name, descrition, _id }) => {
                                return (
                                    <div
                                        className="product__features-item"
                                        key={_id}>
                                        <span className="product__features-name">
                                            {name} :{" "}
                                        </span>
                                        <span className="product__features-descr">
                                            {descrition}
                                        </span>
                                    </div>
                                );
